 ...
 */
#define KEYC_BASE            0x00000000010e000ULL
#define KEYC_USER            0x00000000010f000ULL
#define KEYC_USER_END	     (KEYC_USER + KEYC_NUSER)

/* Key modifier bits. */
#define KEYC_META            0x0000100000000000ULL /* alt */
#define KEYC_CTRL            0x0000200000000000ULL
#define KEYC_SHIFT           0x0000400000000000ULL
#define KEYC_SUPER           0x0000800000000000ULL
#define KEYC_HYPER           0x0001000000000000ULL
#define KEYC_REAL_META       0x0002000000000000ULL /* meta */
#define KEYC_CAPS_LOCK       0x0004000000000000ULL

/* Key flag bits. */
#define KEYC_LITERAL	     0x0010000000000000ULL
#define KEYC_KEYPAD	         0x0020000000000000ULL
#define KEYC_CURSOR	         0x0040000000000000ULL
#define KEYC_IMPLIED_META    0x0080000000000000ULL
#define KEYC_BUILD_MODIFIERS 0x0100000000000000ULL
#define KEYC_VI		         0x0200000000000000ULL
#define KEYC_SENT	         0x0400000000000000ULL
/* Masks for key bits. */
#define KEYC_MASK_MODIFIERS  0x000ff00000000000ULL
#define KEYC_MASK_FLAGS      0x0ff0000000000000ULL
#define KEYC_MASK_KEY        0x00000fffffffffffULL
...
#define TTY_HAVEDA_KITTY 0x2000 /* Primary DA. */
#define TTY_ALL_REQUEST_FLAGS \
	(TTY_HAVEDA|TTY_HAVEDA_KITTY|TTY_HAVEDA2|TTY_HAVEXDA)
	int		 flags;
	int   kitty_state;
